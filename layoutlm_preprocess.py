...
from app.utils import remove_lock_files
...
def model_load(PATH, num_labels):
    ...
    logging.info(f" ### going to remove the LOCK files ")
    directory_path = "/var/www/.cache/"
    remove_lock_files(directory_path)
    logging.info(f" ### Lock Files are removed")
...
def preprocess(image_path,actual_boxes,words):
